...
do
	for DATASUBSET in roman_empire amazon_ratings #minesweeper questions amazon_ratings tolokers questions #squirrel  # chameleon # for DATASUBSET in texas # wisconsin cornell
	do
		DATA_RUN_PATH="$run_base/$run_path/$MODEL/$DATASUBSET"
		mkdir -p "$DATA_RUN_PATH"
