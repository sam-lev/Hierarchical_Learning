...
if __name__ == "__main__":
    ...
    new_filename = file_name_without_ext + "_best_accuracy.txt"
    new_path = os.path.join(parent_directory, 'results', new_filename)
    print("saving optimal test accuracy to ", new_path)
    find_largest_best_test_value(output_file_path, new_path)
